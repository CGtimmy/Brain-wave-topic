...
if nargin<4  startpacksize = 2; end% 預設檔封包的大小startpacksize為2
if nargin<5  endpacksize = 4; end% 預設檔尾封包的大小endpacksize為4

EXG_Point_size = 4; %每點4byte
ACC_Point_size = 2; %每點2byte

EXG_Startbyte = 20;
%everychannelpoint=(packsize-tailpacksize-endpacksize)/4/4;%每一封包的點數
everyEXGchannelpoint = 13;%每一封包的點數
everyACCchannelpoint = 3;%每一封包的點數
